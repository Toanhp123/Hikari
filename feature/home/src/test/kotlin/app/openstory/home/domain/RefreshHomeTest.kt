...
private class FailingSource(override val pluginId: PluginId) : CatalogSource {
    ...
    override suspend fun home(request: SourceHomeRequest) =
        CatalogSourceResult.Failure(CatalogSourceFailure("catalog.unavailable", true))
    override suspend fun search(request: SourceSearchRequest) =
        CatalogSourceResult.Failure(CatalogSourceFailure("unused", false))
    override suspend fun details(sourceId: String) =
        CatalogSourceResult.Failure(CatalogSourceFailure("unused", false))
