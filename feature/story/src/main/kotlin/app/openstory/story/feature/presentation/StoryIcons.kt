...
package app.openstory.story.feature.presentation
...
internal fun BookmarkIcon(
    ...
    size: Dp = 18.dp,
    tint: Color = MaterialTheme.colorScheme.onSurface,
) = StoryIcon(BookmarkVector, size, tint, modifier)
...
internal fun ShareIcon(
    ...
    size: Dp = 18.dp,
    tint: Color = MaterialTheme.colorScheme.onSurface,
) = StoryIcon(ShareVector, size, tint, modifier)
...
internal fun MoreIcon(
    ...
    size: Dp = 18.dp,
    tint: Color = MaterialTheme.colorScheme.onSurface,
) = StoryIcon(MoreVector, size, tint, modifier)
