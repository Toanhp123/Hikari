...
abstract class VerifyStep3BuildSurfaceTask : DefaultTask() {
    @get:InputFile
    ...
    @TaskAction
    fun verifySurface() {
        val violations = Step3BuildSurfaceVerifier.verify(
        ...
        if (violations.isNotEmpty()) {
            throw GradleException(
                buildString {
                    appendLine("Step 3 build surface verification failed:")
        ...
        logger.lifecycle("Step 3 build surface verified.")
    }
}
