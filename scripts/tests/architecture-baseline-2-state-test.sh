...
grep -q 'Wave 08 Tasks 01-06: \*\*IMPLEMENTATION PRESENT\*\*' "$ROOT_DIR/docs/project/current-state.md"
grep -q 'schema 5 current' "$ROOT_DIR/docs/project/current-state.md"
...
grep -q 'Implementation present; verification open' "$ROOT_DIR/docs/implementation/current-roadmap.md"
grep -q 'Complete and review the Wave 08 checkpoint' "$ROOT_DIR/docs/implementation/current-roadmap.md"
