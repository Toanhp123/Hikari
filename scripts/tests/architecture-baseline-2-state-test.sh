...
grep -q 'Wave 07 Task 01' "$ROOT_DIR/docs/project/current-state.md"
grep -q 'schema 3 current' "$ROOT_DIR/docs/project/current-state.md"
...
grep -q 'Continue Wave 07 with Task 01' "$ROOT_DIR/docs/implementation/current-roadmap.md"
...
grep -q 'DOCUMENT LIFECYCLE: ACTIVE / TASK 01 NEXT' "$WAVE_07"
