...
ANDROID_SERIAL="$ANDROID_SERIAL_API_26" \
  ./scripts/instrumentation/architecture-baseline-2.sh 26

ANDROID_SERIAL="$ANDROID_SERIAL_API_37" \
  ./scripts/instrumentation/architecture-baseline-2.sh 37

echo 'Architecture Baseline 2 checkpoint passed on API 26 and API 37.'
