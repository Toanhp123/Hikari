...
class HikariDesignSystemContractTest {
    ...
    fun themeAppliesR28VisualVocabularyWhileKeepingStableRootContracts() {
        ...
        composeRule.runOnIdle {
            ...
            assertEquals(Color(0xFFF4515B), light.primary)
            assertEquals(Color(0xFFFFF9F7), light.surface)
            assertEquals(Color(0xFF211A18), light.onSurface)
            assertEquals(Color(0xFFFF7078), dark.primary)
            assertEquals(Color(0xFF131318), dark.surface)
            assertEquals(Color(0xFF252530), dark.surfaceVariant)
