...
4. **[implementation/waves/wave-05-catalog-home-and-discovery.md](implementation/waves/wave-05-catalog-home-and-discovery.md)** — active implementation plan; Tasks 01-05 have implementation present; Tasks 02-05 are verified and Task 06 is ready to start.
