...
4. **[implementation/waves/wave-05-catalog-home-and-discovery.md](implementation/waves/wave-05-catalog-home-and-discovery.md)** — active implementation plan; Tasks 01-02 are present and Task 02 verification is open.
