...
Reviewed design proposal for implementation planning.

This specification extends the OpenStory declarative selector runtime with a
versioned, typed output-binding system capable of producing every current
Catalog and Content plugin wire DTO.
